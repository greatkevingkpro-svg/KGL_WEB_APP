    ...
    <div class="d-flex">
        ...
        <div class="content p-4 w-100">
            ...
            <div class="content-header d-flex align-items-center justify-content-between mb-3">
                ...
                <button id="sidebarToggle" class="btn btn-success d-md-none" @click="toggleSidebar">
                    ☰ Menu
                </button>
                ...
                <div class="top-bar d-flex align-items-center justify-content-between p-2 rounded flex-grow-1 ms-2">
                    <div class="text-success"><strong>{{ userStore.user.name }}</strong> <span
                            class="badge bg-success text-white">{{ userStore.user.role }}-{{ userStore.user.branch }}</span></div>
