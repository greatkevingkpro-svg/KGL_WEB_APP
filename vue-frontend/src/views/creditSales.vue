					...
					<form id="procForm" @submit.prevent="submitCreditSales">
						...
						<div class="row g-3">
							...
							<div class="col-md-6">
								...
								<input type="text" class="form-control" id="buyerName" v-model="form.buyerName" placeholder="Enter buyer name"
									required>
							</div>
							...
							<div class="col-md-6">
								...
								<input type="text" class="form-control" id="nationalId" v-model="form.nationalId" placeholder="CM12345678901234"
									required>
							</div>
							...
							<div class="col-md-6">
								...
								<input type="text" class="form-control" id="location" v-model="form.location" placeholder="location" required>
							</div>

							<!-- contact -->
							<div class="col-md-6">
								<label for="contact" class="form-label">contact</label>
								<input type="text" class="form-control" id="contact" v-model="form.contact" placeholder="07XXXXXXXX" required>
							</div>
							...
							<div class="col-md-6">
								...
								<input type="number" class="form-control" id="tonnage" v-model="form.tonnage" min="0" step="0.01" required>
							</div>

							<!-- date -->
							<div class="col-md-6">
								<label for="date" class="form-label">Dispatch Date</label>
								<input type="date" class="form-control" id="dispatchDate" v-model="form.dispatchDate" required>
							</div>
							...
							<div class="col-md-6">
								...
								<input type="number" class="form-control" id="amountDue" v-model="form.amountDue" min="0" step="100" required>
							</div>
